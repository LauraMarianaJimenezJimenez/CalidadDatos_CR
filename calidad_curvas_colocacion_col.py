...
# Create path
file = 'C:\\Users\\laura.mariana.jimen1\\Documents\\Calidad_Datos_MIS_CR\\Fuentes_iniciales\\Curva_Colocacion_Col_' + data_date + '.xls'
...
# Create output file
f = open('C:\\Users\\laura.mariana.jimen1\\Documents\\Calidad_Datos_MIS_CR\\Informes\\Informe_curva_colocacion_col' + data_date + '.txt',"w+")
f.write(file)
...
file = 'C:\\Users\\laura.mariana.jimen1\\Documents\\Calidad_Datos_MIS_CR\\Fuentes_procesadas\\Curva_Colocacion_Col_' + data_date + '_' + unix_time + '.xls'
