# Script de calidad de datos, curvas captación, colocación y PIPCA
...
def captacion_col():
	...
	print('Procesando Curva_Captacion_Col...')
				...
				try:	
					...
					for column in df:
						...
						if i == 1:
							...
							if (df[column] >= 1).all():
								f.write("Hay curvas con porcentaje mayor que 1")
					...
					print("Fuente Curva_Captacion_Col procesada con exito")
...
def captacion_dol():
	...
	print('Procesando Curva_Captacion_Dol...')
		...
		try:
			...
			try:
				...
				try:
					...
					df.to_excel(writer, 'Hoja de datos', index=False)
					writer.save()
					print("Fuente Curva_Captacion_Dol procesada con exito")
...
def colocacion_col():
	...
	print('Procesando Curva_Colocacion_Col...')
		...
		try:
			...
			try:
				...
				try:
					...
					df.to_excel(writer, 'Hoja de datos', index=False)
					writer.save()
					print("Fuente Curva_Colocacion_Col procesada con exito")
...
def colocacion_dol():
	...
	print('Procesando Curva_Colocacion_Dol...')
		...
		try:
			...
			try:
				...
				try:
					...
					df.to_excel(writer, 'Hoja de datos', index=False)
					writer.save()
					print("Fuente Curva_Colocacion_Dol procesada con exito")
...
def PIPCA_col():
	...
	print('Procesando Curva_PIPCA_Col...')
		...
		try:
			...
			try:
				...
				try:
					...
					df.to_excel(writer, 'Hoja de datos', index=False)
					writer.save()
					print("Fuente Curva_PIPCA_Col procesada con exito")
...
def PIPCA_dol():
	...
	print('Procesando Curva_PIPCA_Dol...')
		...
		try:	
			...
			try:
				...
				try:
					...
					df.to_excel(writer, 'Hoja de datos', index=False)
					writer.save()
					print("Fuente Curva_PIPCA_Dol procesada con exito")
